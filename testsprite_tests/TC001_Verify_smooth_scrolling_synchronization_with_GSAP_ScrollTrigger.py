...
async def run_test():
    ...
    try:
        ...
        # -> Observe scrolling behavior and GSAP animations for smoothness and synchronization on desktop.
        await page.mouse.wheel(0, 500)
        

        # -> Simulate mobile viewport and test scrolling and GSAP animation synchronization on mobile.
