...
async def run_test():
    ...
    try:
        ...
        # -> Test the homepage on a low-end mobile device to verify particle globe rendering, animations, and frame rate.
        await page.goto('about:blank', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Reload the homepage on a low-end mobile device emulator or viewport to verify particle globe rendering, animations, and frame rate.
        await page.goto('http://localhost:3000', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Simulate low-end mobile device viewport and verify particle globe rendering, continent highlighting, intro animation smoothness, and frame rate.
        await page.goto('http://localhost:3000', timeout=10000)
        await asyncio.sleep(3)
        ...
        # -> Scroll down to reveal more page content and check for any mobile-specific UI or performance indicators.
        await page.mouse.wheel(0, 600)
        

        # -> Simulate low-end mobile device viewport and performance to verify particle globe rendering, continent highlighting, intro animation smoothness, and frame rate.
        await page.goto('http://localhost:3000', timeout=10000)
        await asyncio.sleep(3)
        ...
        # -> Simulate low-end mobile device viewport and performance profile to verify particle globe rendering, continent highlighting, intro animation smoothness, and frame rate.
        frame = context.pages[-1]
        # Open language selection or device settings to simulate mobile viewport
