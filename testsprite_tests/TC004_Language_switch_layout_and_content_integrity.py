...
async def run_test():
    ...
    try:
        ...
        # -> Toggle language from Korean to English and vice versa repeatedly and verify no UI breakage or text truncation in the Hero section.
        frame = context.pages[-1]
        # Click KO button to switch language to Korean
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Click EN button to switch language back to English
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Scroll down to Vision & Value section and toggle language between Korean and English to verify UI layout and text correctness.
        await page.mouse.wheel(0, 600)
        

        frame = context.pages[-1]
        # Toggle language to Korean in Vision & Value section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Toggle language back to English in Vision & Value section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Scroll down to Bento Grid section and toggle language between Korean and English to verify UI layout and text correctness.
        await page.mouse.wheel(0, 600)
        

        frame = context.pages[-1]
        # Toggle language to Korean in Bento Grid section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Toggle language back to English in Bento Grid section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Scroll down to How It Moves section and toggle language between Korean and English to verify UI layout and text correctness.
        await page.mouse.wheel(0, 600)
        

        frame = context.pages[-1]
        # Toggle language to Korean in How It Moves section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Toggle language back to English in How It Moves section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Scroll down to Economy & Revenue section and toggle language between Korean and English to verify UI layout and text correctness.
        await page.mouse.wheel(0, 600)
        

        # -> Scroll down to Footer section and toggle language between Korean and English to verify UI layout and text correctness.
        await page.mouse.wheel(0, 600)
        

        frame = context.pages[-1]
        # Toggle language to Korean in Footer section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        frame = context.pages[-1]
        # Toggle language back to English in Footer section
        elem = frame.locator('xpath=html/body/main/nav/div/div/div/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
