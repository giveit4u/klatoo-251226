    ...
    return (
        <div ref={containerRef} className="w-full bg-[#030308] text-white overflow-hidden relative font-sans">
            ...
            <section id="about" className="vision-section relative w-full min-h-[800px] flex flex-col justify-center items-center px-6 py-32 md:py-64 overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl w-full text-center space-y-12">
                    <div className="vision-text space-y-4">
                        <h2 className="text-[#08CEFF] tracking-[0.2em] text-[16px] md:text-[18px] font-bold uppercase">{t('info.vision.subtitle')}</h2>
                        <h1 className={`text-4xl md:text-7xl tracking-tight text-white ${language === 'ko' ? 'leading-[1.3] md:leading-[87px] font-extrabold' : 'leading-[34px] md:leading-[62px]'}`}>
                            <span className={language === 'en' ? 'font-accent font-light text-[28.8px] md:text-[57.6px] inline-block' : ''}>{t('info.vision.title1')}</span><br />
                            <span className={language === 'en' ? 'font-display font-bold' : ''}>{t('info.vision.title2')}</span>
                        </h1>
                    ...
                    <div className="vision-text grid grid-cols-1 md:grid-cols-2 gap-12 text-left bg-[#0A0A0A]/20 backdrop-blur-[12px] md:backdrop-blur-[80px] p-8 md:p-12 rounded-2xl border border-white/10 shadow-2xl">
                        ...
                        <div className="space-y-6 flex flex-col justify-center md:border-l-[1px] border-[#08CEFF]/50 md:pl-8">
                            <p className="text-xl md:text-3xl font-light text-white leading-snug">
                                {t('info.vision.card2.quote1')}<br />
                                <span className="font-bold text-[#08CEFF]">{t('info.vision.card2.quote2')}</span>
            ...
            <section id="features" className="features-section w-full px-6 py-40 md:py-72 bg-[#050505]">
                <div className="max-w-7xl mx-auto space-y-16">
                    <div className="text-center space-y-4 mb-20">
                        <h2 className="bento-item text-[#08CEFF] font-bold tracking-widest uppercase text-[18px]">{t('info.features.subtitle')}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
                        ...
                        <div className="bento-item col-span-1 md:col-span-1 row-span-2 bg-[#0A0A0A] rounded-3xl p-8 border border-white/5 hover:border-[#08CEFF]/30 transition-colors duration-500 overflow-hidden group relative min-h-[500px] md:min-h-0">
                            ...
                            <div className="absolute top-0 right-0 w-full h-1/2 bg-gradient-to-b from-[#08CEFF]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                            <div className="h-full flex flex-col justify-between relative z-10">
                                <div className="w-12 h-12 bg-[#08CEFF] rounded-full flex items-center justify-center mb-6">
                        ...
                        <div className="bento-item col-span-1 md:col-span-2 bg-[#111] rounded-3xl p-8 border border-white/5 hover:border-[#08CEFF]/30 transition-all duration-500 relative overflow-hidden group">
                            ...
                            <div className="mt-8 flex items-center space-x-4 relative z-10">
                                <span className="px-4 py-2 bg-[#111111] rounded-full text-xs uppercase tracking-wider text-[#08CEFF] group-hover:bg-[#08CEFF]/10 transition-colors border border-white/5">{t('info.features.card2.local')}</span>
                                    ...
                                    <svg width="48" height="12" viewBox="0 0 48 12" fill="none" className="opacity-60 group-hover:opacity-100 transition-opacity duration-500">
                                        ...
                                        <defs>
                                            <linearGradient id="flowGradient" x1="0" y1="6" x2="45" y2="6" gradientUnits="userSpaceOnUse">
                                                <stop stopColor="#08CEFF" stopOpacity="0.2" />
                                                <stop offset="1" stopColor="#08CEFF" />
                                            </linearGradient>
                                        </defs>
                                    </svg>
                                </div>
                        ...
                        <div className="bento-item col-span-1 md:col-span-2 bg-[#080808] rounded-3xl p-8 border border-white/5 relative overflow-hidden flex flex-col md:flex-row items-center cursor-pointer group hover:bg-[#0C0C0C] transition-colors">
                            ...
                            <div className="relative z-10 w-full">
                                <h4 className="text-3xl font-bold mb-3"><span className="text-[#08CEFF]">Kubic.</span> {t('info.features.card3.title')}</h4>
                                <p className="text-gray-300">{t('info.features.card3.desc')}</p>
                            </div>
                            <div className="relative z-10 mt-6 md:mt-0 md:ml-auto">
                                <span className="inline-flex items-center justify-center w-16 h-16 rounded-full border border-white/20 group-hover:border-[#08CEFF] group-hover:text-[#08CEFF] transition-all">
            ...
            <section className="kubic-section w-full py-40 md:py-72 bg-black relative overflow-hidden">
                ...
                />
                <div className="kubic-scanline absolute left-0 w-full h-32 bg-gradient-to-b from-transparent via-[#08CEFF15] to-transparent z-[1] pointer-events-none" />

                <div className="max-w-7xl mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    {/* Left Column: Copy */}
                    <div className="lg:col-span-4 space-y-8">
                        <h2 className="text-[#08CEFF] font-bold tracking-widest uppercase text-[16px]">{t('info.kubic.subtitle')}</h2>
                        ...
                        <div className="pl-6 border-l-[5px] border-[#08CEFF]">
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`kubic-tab w-full text-left p-6 rounded-2xl border transition-[background-color,border-color,box-shadow] duration-500 flex items-start gap-6 group backdrop-blur-sm
                                    ${activeTab === i
                                        ? 'bg-white/[0.08] border-[#08CEFF]/50 shadow-[0_8px_32px_0_rgba(8,239,255,0.15)] opacity-100'
            ...
            <section id="kubic" className="economy-section w-full min-h-[850px] py-40 md:py-72 bg-[#030303] relative flex flex-col justify-center">
                ...
                <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-[#08CEFF] font-bold tracking-widest uppercase mb-4 text-[18px]">{t('info.economy.subtitle')}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-stretch">
                        ...
                        <div className="economy-left h-full bg-white/[0.015] backdrop-blur-xl rounded-3xl p-10 border border-white/10 space-y-10 shadow-2xl relative overflow-hidden group flex flex-col justify-between">
                            <div className="absolute inset-0 bg-gradient-to-br from-[#08CEFF]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                            <div className="relative z-10">
                                <h4 className="text-2xl font-bold mb-4 flex items-center">
                                    <span className="w-[5px] h-8 bg-[#08CEFF] mr-4 rounded-sm" />
                                ...
                                <ul className="mt-6 space-y-6">
                                    {[
                                        ...
                                        <li key={idx} className="flex items-center text-white/90 font-medium group/item hover:text-white transition-colors duration-300">
                                            <div className="w-10 h-10 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mr-4 group-hover/item:border-[#08CEFF]/50 group-hover/item:bg-[#08CEFF]/10 transition-all duration-500">
                                                <svg className="w-5 h-5 text-[#08CEFF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    {item.icon}
                                                </svg>
                                            </div>
                                            {item.text}
                        ...
                        <div className="economy-right h-full flex flex-col gap-8">
                            <div className="flex-1 bg-white/[0.015] backdrop-blur-xl p-8 rounded-2xl border border-white/10 shadow-xl group/box relative overflow-hidden flex flex-col justify-center">
                                ...
                                <div className="relative z-10">
                                    <h5 className="text-gray-400 uppercase text-[14px] tracking-wider mb-6 flex items-center gap-2">
                                        <div className="w-1 h-1 rounded-full bg-[#08CEFF]" />
                                    ...
                                    <div className="grid grid-cols-2 gap-8">
                                        ...
                                        <div>
                                            <p className="text-xl font-bold text-[#08CEFF] mb-2">{t('info.economy.right.box.row2.title')}</p>
                            ...
                            <div className="flex-1 bg-gradient-to-br from-[#1a1540]/25 to-[#08CEFF]/05 p-10 rounded-3xl border border-[#08CEFF]/30 relative overflow-hidden text-left group backdrop-blur-2xl shadow-2xl hover:shadow-[#08CEFF]/10 transition-all duration-500 flex flex-col justify-center">
                                ...
                                <div className="relative z-10">
                                    <button className="px-8 py-3 bg-[#08CEFF] text-[#03030a] font-bold rounded-full hover:bg-white hover:text-[#03030a] transition-colors shadow-lg shadow-[#08CEFF]/20">
                                ...
                                <div className="absolute inset-0 bg-[#08CEFF]/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                            </div>
                        </div>
            ...
            <section className="global-section w-full min-h-[700px] py-40 md:py-72 relative flex items-center justify-center overflow-hidden bg-black">
                ...
                <div className="relative z-10 text-center px-6 max-w-6xl mx-auto space-y-16 py-24">
                    {/* Main Headline */}
                    <div className="space-y-6">
                        <h2 className={`text-3xl md:text-5xl lg:text-[3.5rem] md:whitespace-nowrap break-keep text-transparent bg-clip-text bg-gradient-to-r from-white via-[#8B7FFF] to-[#08CEFF] py-4 leading-[1.3] lg:leading-[71px] tracking-tight ${language === 'ko' ? 'font-bold' : 'font-display font-normal'}`}>
                            {t('info.cta.title')}
                        </h2>
                    ...
                    {/* Footer Tagline */}
                    <div className="pt-16">
                        <p className="text-[19.2px] md:text-[21.6px] tracking-[0.3em] uppercase text-[#FFBB00]">
                            {t('info.cta.tagline')}
                        </p>
                    </div>
                </div>
